...
const Form = () => {
  ...
  return (
    <div
      id="book-now"
      className="py-20 flex flex-col items-center justify-center bg-gray-100 px-4"
    >
      ...
      <div className="bg-white shadow-md rounded-lg p-8 w-full max-w-lg">
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-orange-500 hover:bg-orange-600 active:scale-95 text-white font-semibold py-3 rounded-full shadow-md transition duration-200"
          >
            Get Callback
          </button>

          {status && (
            <p className="text-sm text-center mt-4 whitespace-pre-line">
              {status}
            </p>
          )}
        </form>
